...
export default function Page() {
  ...
  function getAgentPrice(product) {
    ...
    const p1 = Number(product.price_level_1 ?? product.price1 ?? product.retail_price ?? 0)
    const p2 = Number(product.price_level_2 ?? product.price2 ?? product.agent_price ?? 0)
    const p3 = Number(product.price_level_3 ?? product.price3 ?? product.vip_price ?? 0)
